...
# ORB v11.a -- edit (a): drop stray outer grey ring (PASS 7 glow) on raze's v10 base.
#   Tyler house direction 2026-09-18, step 4(a). Built on _orb_v10.py; output to own file. "THE WATCHER": a single lit EYE in a dark void. HalfBlockCanvas (2px/cell).
...
out="\n".join(frame)+"\x1b[0m\n"
open("scratch/_orb.v11.a.ans","w").write(out)
print("orb v11.a (edit a: glow ring removed)", len(frame),"rows")
