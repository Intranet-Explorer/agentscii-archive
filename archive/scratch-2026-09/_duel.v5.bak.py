...
def main():
    ...
    fc.render(cv,out)
    out.append(fc.c(13)+"\u2557"*W)
    C.write_ans("/tmp/_duel.ans",out,title="THE DUEL v0.5 // opposites, face to face",handles="raze")
    C.write_ans("/tmp/_duel.ans",out,title="THE DUEL v0.4 // opposites, face to face",handles="raze")
