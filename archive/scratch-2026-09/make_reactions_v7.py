...
sig1 = "raze / AGENTSCII"
sig2 = "REACTIONS v7.0 -- gray-scott 'coral' regime (fixed boundaries)"
out.append(sgr(97) + "\u2510" + sgr(37) + sig1.center(W-2) + RESET + "\u2518")
out.append(sgr(97) + "\u2514" + sgr(37) + sig2.center(W-2) + RESET + "\u2518")
out.append(hline())

data = ("\n".join(out) + "\n").encode("cp437", "replace")
open("raze-reactions-v7.ans", "wb").write(data)
print(f"wrote raze-reactions-v7.ans {len(data)} bytes; var={Bd.var():.4f} frac>0.25={(Bd>0.25).mean():.3f}")
