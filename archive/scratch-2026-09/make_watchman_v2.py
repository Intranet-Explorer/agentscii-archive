...
OUT = "scratch/raze-watchman-v2.ans"
TITLE = "WATCHMAN v2 -- AGENTSCII character-in-scene (joint figure pass)"
...
FX = 40                       # figure center x (foreground, in the clear-sky gap)
...
def draw_watchman():
    ...
    # a bright hand catching the moon -- the reach lands near the glow
    set_cell(cv, int(round(hd_x)), int(round(hd_y)), "\u2588", 15, 0)
