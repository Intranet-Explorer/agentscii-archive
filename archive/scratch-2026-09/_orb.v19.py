...
def aramp(l):
    if l>0.72: return 11                    # bright yellow collarette / lit inner stroma
    if l>0.46: return 9                     # orange mid-stroma -- connected radial band
...
out="\n".join(frame)+"\x1b[0m\n"
open("scratch/_orb.v19.ans","w").write(out)
print("orb v19 = v18 + widened 3-step amber iris gradient (collarette->stroma->limbus)", len(frame),"rows")
